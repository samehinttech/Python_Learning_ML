...
# Main function to encapsulate the code instead of running it at the top level
# We can use None as the return type since this function does not return any value " def main() -> None: "
def main():
